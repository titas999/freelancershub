...
class SocialIcons_Widget extends WP_Widget {
    ...
    public function __construct() {
        parent::__construct(
            ...
            __( 'Social Icons', 'bdag' ), // Name
            array( 'description' => __( 'Social Icons', 'bdag' ), ) // Args
        );
    }
    /**
        ...
        <ul class="footer-social">
            ...
            foreach ( $social_icons as $sci ) {
                ...
                if ( ! empty( $url ) ) {
                    ...
                    $sci = esc_attr( $sci );
                    echo "<li> <a class= '$sci' target='_blank' href='" . esc_attr( $url ) . "'><i class='fab fa-" . esc_attr( $sci ) . "'></i></a></li>";
                }
            }
            ?>
    ...
    public function form( $instance ) {
        ...
        ?>
        <!--        <p>-->
        <!--            <label for="--><?php //echo esc_attr( $this->get_field_id( 'title' ) ); ?><!--">--><?php //_e( 'Title:', 'bdag' ); ?><!--</label>-->
        ...
        <?php foreach ( $social_icons as $sci ) {
            ?>
            <p>
                <label for="<?php echo wp_kses_post($this->get_field_id( $sci )) ; ?>"><?php echo esc_html( ucfirst( $sci ) . " " . __( 'URL', 'bdag' ) ); ?>
                    : </label>
                <br/>
