...
<!-- Mirrored from templates.envytheme.com/freelancershub/single-projects.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 11 Jan 2020 15:32:06 GMT -->
<head>
        <!-- Required meta tags -->
        <meta charset="utf-8">
                    ...
                    <nav class="navbar navbar-expand-md navbar-light">
                        ...
                        <div class="collapse navbar-collapse mean-menu" id="navbarSupportedContent">
                            <ul class="navbar-nav">
                                ...
                                <li class="menu-item">
                                    <a href="#" class="nav-link active">Projects 
                                        <i class="fa fa-plus"></i>
                                    </a>
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li class="menu-item">
                                            <a href="single-projects.html" class="nav-link active">Projects Details</a>
                                        </li>
                                    </ul>
                                </li>
                    ...
                    <div class="col-lg-12 col-md-12">
                        <div class="projects-details-desc">
                            ...
                            <div class="project-details-info">
                                ...
                                <div class="single-info-box">
                                    <a href="#" class="default-btn-one">Live Preview</a>
                                </div>
                            </div>
                        </div>
                    </div>
